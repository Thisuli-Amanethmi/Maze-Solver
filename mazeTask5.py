...
def create_maze(columns, rows):
    ...
    while count <= 4:
        ...
        barrier_cell = [barrier_column, barrier_row]
        if maze[barrier_column][barrier_row] != ' S ' and maze[barrier_column][barrier_row] != ' G ' and barrier_cell not in barriers:
            barriers.append(barrier_cell)
            maze[barrier_column][barrier_row] = ' | '
            count += 1
